...
from models.tiny_simsiam import TinySimSiamHead
from models.feat_view import make_feat_view
...
class CPTModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        # Tiny SimSiam auxiliary loss in feature space
        parser.add_argument('--lambda_simsiam', type=float, default=0.05,
                    help='weight for SimSiam gt')
        parser.add_argument('--simsiam_layer_index', type=int, default=-2,
                            help='which NCE feature index to use for SimSiam (e.g., -2 = mid)')
    ...
    def __init__(self, opt):
        ...
        # SimSiam auxiliary loss
        if self.isTrain and opt.lambda_simsiam > 0:
